        ...
        <div className="max-w-2xl mx-auto">
          {submitted ? (
            <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
              <h3 className="text-xl font-medium text-green-800">¡Solicitud enviada!</h3>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-8">
              ...
              <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-4">
                ...
                <textarea placeholder="Describe tu proyecto *" required rows={4} className="w-full px-4 py-3 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-[#1E40AF] resize-none" />
