      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl border border-gray-100 p-8">
            <div className="w-12 h-12 bg-[#1E40AF]/10 rounded-lg flex items-center justify-center mb-4 text-2xl">⚡</div>
            <h3 className="font-medium text-xl text-gray-900 mb-3">Misión</h3>
            <p className="text-gray-600">Democratizar el acceso a tecnología de climatización eficiente en Latinoamérica, acompañando al instalador en cada paso.</p>
          </div>
          <div className="bg-white rounded-xl border border-gray-100 p-8">
            <div className="w-12 h-12 bg-[#F97316]/10 rounded-lg flex items-center justify-center mb-4 text-2xl">👁️</div>
            <h3 className="font-medium text-xl text-gray-900 mb-3">Visión</h3>
            <p className="text-gray-600">Ser la marca de bombas de calor más confiable de Latinoamérica para 2030.</p>
          </div>
          <div className="bg-white rounded-xl border border-gray-100 p-8">
            <div className="w-12 h-12 bg-[#059669]/10 rounded-lg flex items-center justify-center mb-4 text-2xl">❤️</div>
            <h3 className="font-medium text-xl text-gray-900 mb-3">Valores</h3>
            <p className="text-gray-600">Compromiso, Transparencia, Excelencia técnica, Cercanía.</p>
          </div>
        </div>
      </section>
    </div>
